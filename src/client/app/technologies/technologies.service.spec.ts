...
export function main() {
  describe('NameList Service', () => {
    let nameListService: TechnologiesService;
    ...
    it('should return an Observable when get called', async(() => {
      expect(TestBed.get(TechnologiesService).get()).toEqual(jasmine.any(Observable));
    }));

    it('should resolve to list of names when get called', async(() => {
      let nameListService = TestBed.get(TechnologiesService);
